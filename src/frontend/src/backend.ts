...
export class Backend implements backendInterface {
    ...
    async getPlayerPosition(): Promise<PlayerPosition> {
        if (this.processError) {
            try {
                const result = await this.actor.getPlayerPosition();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async loadWorld(arg0: string): Promise<Uint8Array> {
        if (this.processError) {
            try {
                const result = await this.actor.loadWorld(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveWorld(arg0: string, arg1: Uint8Array): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveWorld(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updatePlayerPosition(arg0: number, arg1: number, arg2: number): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updatePlayerPosition(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
